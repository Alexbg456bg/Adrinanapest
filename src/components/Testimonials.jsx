...
const REVIEWS = [
  {
    name: 'Клиент',
    role: 'Жилищен имот, София',
    text: 'Бърза и коректна реакция при проблем с дървеници. Екипът обясни всичко предварително и проблемът беше решен от първия път.',
  },
  {
    name: 'Клиент',
    role: 'Търговски обект, София',
    text: 'Работим на абонамент вече повече от година — редовни прегледи и никакви изненади при проверка от РЗИ.',
  },
  {
    name: 'Клиент',
    role: 'Складово помещение, София',
    text: 'Професионално отношение и ясна гаранция. Ще ги препоръчам на всеки, който търси сериозна ДДД фирма.',
  },
]
